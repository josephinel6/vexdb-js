...
async function geteventrankingforteam(teamid, eventit) {
    const teamranking = await fetch(fetch(teamsurl + "/" + viewteamid + "/rankings?event=" + response.data[i].id, data));
