...
function viewteam() {
    ...
    fetch(teamsurl + "/" + viewteamid, data)
        ...
        .then(response => {
            ...
            // document.getElementById("viewteamwebsite").href = "www.robotevents.com/teams/" + response.program.code + "/" + response.number;
            document.getElementById("viewteamwebsite").setAttribute(onclick, function () { "www.robotevents.com/teams/" + response.program.code + "/" + response.number });
